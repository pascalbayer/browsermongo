(function (e) {
    if ("function" == typeof bootstrap)bootstrap("nedb", e); else if ("object" == typeof exports)module.exports = e(); else if ("function" == typeof define && define.amd)define(e); else if ("undefined" != typeof ses) {
        if (!ses.ok())return;
        ses.makeNedb = e
...
// Interface
        ...
        }, {"./model": 10, "binary-search-tree": 14, "underscore": 18, "util": 3}],
        ...
        12: [function (require, module, exports) {
            ...
            function exists(filename, callback) {
                ...
                if (typeof localStorage === 'undefined') {
                    console.log("WARNING - This browser doesn't support localStorage, no data will be saved in NeDB!");
                    return callback();
                }
...
// Interface
        ...
        }, {"./bst": 16, "./customUtils": 17, "underscore": 18, "util": 3}],

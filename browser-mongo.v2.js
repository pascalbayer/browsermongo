(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('browsermongo', ['lodash'], function (b) {
            return factory(b);
        });
    } else if (typeof exports === 'object') {
        module.exports = factory(require('lodash'));
    } else {
        root.BrowserMongo = factory(root._);
    }
}(this, function () {
    'use strict';
    ...
    // BrowserMongo singleton implementation
    var BrowserMongo = (function () {
        // Instance stores a reference to the BrowserMongo singleton
        var instance;
    ...
    return BrowserMongo.getInstance;
}));